...
#nadya.login(qr=True)
nadya.login(token='ErxyAOmJykHBRvNz9QF1.ztD+p04v5TINM7hTPRRiyq.I8rQgHCpScQ6UM5NiZUW813bIVH8VdvbrNqOiiDs/hs=')
nadya.loginResult()
...
╚═════════════════════════
"""
tjia="u65377f3f4e15e6d8a79bb1eda6bac861"
...
KAC=[VyanLay]
mid = VyanLay.getProfile().mid
Bots=[mid]
Creator=["u65377f3f4e15e6d8a79bb1eda6bac861"]
admin=["u65377f3f4e15e6d8a79bb1eda6bac861"]
...
responsename = Vyanlay.getProfile().displayName
...
wait = {
    ...
    'timeline':True,
    "Timeline":True,
    "comment":"Bot Auto Like ©By : Vyanlay\nContact Me : 👉 line.me/ti/p/~Vyanlay",    
    "commentOn":True,
    "commentBlack":{},
